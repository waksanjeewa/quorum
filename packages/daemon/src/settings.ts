...
export const MODEL_CATALOG = {
  providers: [
    ...
    { id: "github", label: "GitHub Models · Copilot users' GitHub token", kind: "api", aggregator: true, prefix: "github/", keyEnv: "GITHUB_TOKEN", baseUrl: "https://models.inference.ai.azure.com", fetchModels: false, models: ["gpt-4o-mini", "gpt-4o", "Meta-Llama-3.1-70B-Instruct", "Mistral-Large-2411"] },
